"""
Django settings for verbal_information_webservice project.
...
SECRET_KEY = "django-insecure-x(zkvek@q7uup=_a+tnh1751d%q8$v877g2q8kb!))npr#2xzn"
...
WSGI_APPLICATION = "verbal_information_webservice.wsgi.application"
