...
### Request
git
`GET api/v1/verbal/information/list`
...
`POST api/v1/verbal/information/create`
...
`PUT api/v1/verbal/information/<int:pk>/update`
...
`DELETE api/v1/verbal/information/<int:pk>/destroy`
